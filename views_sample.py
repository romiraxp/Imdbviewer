...
def index(request):
    ...
    if request.method == "POST":
        ...
        # if product_search:
        #     imdb_list_filtered = Imdb.objects.filter(product_id__contains=product_search)[:10000]
        ...
        #     # return render(request, 'imdb/index.html', context)
        # elif barcode_search:
        #     imdb_list_filtered = Imdb.objects.filter(code__contains=barcode_search)[:10000]
        ...
        #     # return render(request, 'imdb/index.html', context)
        # elif descr_search:
        #     imdb_list_filtered = Imdb.objects.filter(description__icontains=descr_search)[:10000]
        ...
        #     # return render(request, 'imdb/index.html', context)
        # elif ctgr_search:
        #     imdb_list_filtered = Imdb.objects.filter(category__icontains=ctgr_search)[:10000]
        ...
        #     # return render(request, 'imdb/index.html', context)
        # elif brnd_search:
        #     imdb_list_filtered = Imdb.objects.filter(brand__icontains=brnd_search)[:10000]
        ...
        #     # return render(request, 'imdb/index.html', context)
        # elif mnf_search:
        #     imdb_list_filtered = Imdb.objects.filter(manufacturer__icontains=mnf_search)[:10000]
        ...
        #     # return render(request, 'imdb/index.html', context)
        # elif sts_search:
        #     imdb_list_filtered = Imdb.objects.filter(status__contains=sts_search)[:10000]
